//#region ../../../1-framework/0-foundation/contract/dist/domain-envelope-CENjHN4U.d.mts
...
type ContractToManyRelation = {
  readonly to: CrossReference;
  readonly cardinality: '1:N';
  readonly on: ContractRelationOn;
  readonly through?: never;
};
type ContractNonJunctionRelation = ContractToOneRelation | ContractToManyRelation;
...
//#endregion
export { StorageNamespace as $, DocIndex as A, JsonPrimitive as B, ContractToOneRelation as C, CrossReference as D, ContractWithDomain as E, ExecutionMutationDefaultValue as F, PlanMeta as G, LedgerEntryRecord as H, ExecutionSection as I, ScalarFieldType as J, ProfileHashBase as K, Expr as L, ExecutionHashBase as M, ExecutionMutationDefault as N, CrossReferenceSchema as O, ExecutionMutationDefaultPhases as P, StorageHashBase as Q, FieldType as R, ContractToManyRelation as S, ContractVariantEntry as T, ModelStorageBase as U, JsonValue as V, NamespaceId as W, StorageBase as X, Source as Y, StorageEntitySlot as Z, ContractNonJunctionRelation as _, ColumnDefault as a, crossRef as at, ContractRelationOn as b, ContractDiscriminator as c, isColumnDefaultLiteralInputValue as ct, ContractField as d, UnionFieldType as et, ContractFieldType as f, ContractModelBase as g, ContractModel as h, Brand as i, coreHash as it, EmbedRelationKeys as j, DocCollection as k, ContractEmbedRelation as l, isExecutionMutationDefaultValue as lt, ContractMarkerRecord as m, ApplicationDomain as n, ValueSetRef as nt, ColumnDefaultLiteralInputValue as o, executionHash as ot, ContractManyToManyRelation as p, ReferenceRelationKeys as q, ApplicationDomainNamespace as r, asNamespaceId as rt, ColumnDefaultLiteralValue as s, isColumnDefault as st, $ as t, ValueObjectFieldType as tt, ContractEnum as u, profileHash as ut, ContractReferenceRelation as v, ContractValueObject as w, ContractRelationThrough as x, ContractRelation as y, GeneratedValueSpec as z };
//# sourceMappingURL=domain-envelope-CENjHN4U-BIIt9bl4.d.mts.map