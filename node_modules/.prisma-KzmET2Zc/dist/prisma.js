...
const cliGroups = {
	...
	project: {
		...
		workflow: [
			...
			{
				run: "git connect",
				brief: "Connect GitHub so every push deploys"
			},
			{
	...
	git: {
		brief: "Manage the GitHub connection that deploys on push. Connect or disconnect a repository",
		description: "Connecting a GitHub repository turns on deploy-on-push: pushing a Git branch builds and deploys it to a matching Platform Branch. Disconnecting stops push deploys without touching anything already deployed."
	},
	service: {
